  ...
  function HeroMedia({ profile }) {
    useEffect(function () {
      ...
      function draw() {
        ...
        for (const b of binary) {
          ...
          ctx.font = b.size + 'px "Fira Code", monospace'
          ctx.fillText(b.value, b.x, b.y)
          b.y += b.speed
          if (b.y > height + 20) {
            b.y = -20
            b.x = Math.random() * width
            b.value = Math.random() > 0.5 ? '1' : '0'
          }
        }
    ...
    return e.createElement(
      ...
      e.createElement(
        ...
        e.createElement('canvas', { id: 'hero-neural-canvas', className: 'hero-neural-canvas' }),
        profile?.photo
          ? e.createElement(
              'div',
              {
              ...
              e.createElement('img', {
                src: profile.hero_photo || profile.photo,
